...
import com.example.g8shopadmin.databinding.ItemContainerReceivedProductBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int VIEW_TYPE_RECEIVED_PRODUCT = 6;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_SENT) {
            ...
            return new ReceivedProductViewHolder(
                    ItemContainerReceivedProductBinding.inflate(
                            LayoutInflater.from(parent.getContext()),
                            parent,
                            false
                    )
    ...
    public int getItemViewType(int position) {
        if (chatMessages.get(position).senderId.equals(senderId)) {
            ...
            if(chatMessages.get(position).messageImage != null && chatMessages.get(position).message != "" && chatMessages.get(position).message != null){
                return VIEW_TYPE_RECEIVED_PRODUCT;
            } else if(chatMessages.get(position).messageImage !=  null){
    ...
    static class ReceivedProductViewHolder extends RecyclerView.ViewHolder {
        private final ItemContainerReceivedProductBinding binding;

        ReceivedProductViewHolder(ItemContainerReceivedProductBinding itemContainerReceivedProductBinding) {
            super(itemContainerReceivedProductBinding.getRoot());
